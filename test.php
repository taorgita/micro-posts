...
?>
                        <li>
                            ...
                            <form class = "inlineform" action="" method="POST">
                                <input type="hidden" value="<?php echo $post_record[0] ?>" name="delete_id">
                            <button class = "deletebutton" type="submit" name = "post_delete" value= <?php echo $post_record[0];?>>削除</button>
                            </form>
                        </li>
<?php
                    }
